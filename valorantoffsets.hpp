namespace Offsets {
	// global
	uint64_t uworld_key = 0x8FB6978;
	uint64_t uworld_state = 0x8FB6940;
	...
	// vector
	uint64_t root_component = 0x250;			// world > game_instance > localplayers_array[0] > playercontroller > apawn > root_component				// aactor > root_component
	...
	// controllers
	uint64_t damage_controller = 0x998;			// world > game_instance > localplayers_array[0] > playercontroller > apawn > damage_controller				// aactor > damage_controller
